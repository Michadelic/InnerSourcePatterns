...
* [Repository Activity Score](patterns/2-structured/innersource-activity-score.md) - *The repository activity score is a numeric value that represents the (GitHub) activity of an InnerSource project.*
